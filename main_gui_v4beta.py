"""
main_gui_v4beta.py — CSIT_ACPA V4 Beta 自动输入 GUI

基于 core_logic_v4(SendInput Unicode 逐字符注入)的现代风格界面:
  - 深色主题 + 大号状态显示
  - 热键回调经 after(0, ...) 转主线程, 避免 tkinter 线程安全问题
  - 日志/完成回调同样经 after 转发, 状态复位由 on_done 统一处理(无竞态)
"""
...
class ModernAutoTyperGUI:
    ...
    def _build_ui(self) -> None:
        ...
        hotkey_frame.pack(pady=(0, 15), padx=40, fill="x")
        ...
        log_frame.pack(pady=(0, 20), padx=40, fill="both", expand=True)
